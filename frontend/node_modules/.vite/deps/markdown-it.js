...
// node_modules/markdown-it/node_modules/entities/dist/generated/decode-data-xml.js
...
// node_modules/markdown-it/node_modules/entities/dist/escape.js
...
// node_modules/markdown-it/node_modules/entities/dist/internal/encode-shared.js
...
var XML_BITSET = new Uint32Array([0, XML_BITSET_VALUE, 0, 0]);
...
var REBuilder = class {
  ...
  get_ipv4_addr() {
    var _a;
    return (_a = this.cache).src_ip4 ?? (_a.src_ip4 = new RegExp("(?:(?:25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])[.]){3}(?:25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])"));
  }
  get_ipv6_addr() {
    var _a;
  ...
  get_port() {
    var _a;
    return (_a = this.cache).src_port ?? (_a.src_port = new RegExp("(?::(?:6(?:[0-4]\\d{3}|5(?:[0-4]\\d{2}|5(?:[0-2]\\d|3[0-5])))|[1-5]?\\d{1,4}))?"));
  }
  get_host_terminator() {
    var _a;
  ...
  get_mail_name() {
    var _a;
    return (_a = this.cache).src_mail_name ?? (_a.src_mail_name = new RegExp("[-!#$%&'*+/=?^_`{|}~a-zA-Z0-9](?:[-!#$%&'*+/=?^_`{|}~a-zA-Z0-9]|[.](?=[-!#$%&'*+/=?^_`{|}~a-zA-Z0-9])){0,63}"));
  }
  get_xn() {
    var _a;
    return (_a = this.cache).src_xn ?? (_a.src_xn = new RegExp("xn--[a-z0-9\\-]{1,59}"));
  }
  get_tld() {
  ...
  get_path_extra() {
    var _a;
    return (_a = this.cache).src_path_extra ?? (_a.src_path_extra = new RegExp(""));
  }
