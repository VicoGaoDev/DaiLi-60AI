...
class ExternalApiSceneBinding(Base):
    ...
    custom_size_max = Column(Integer, nullable=False, default=4096, server_default="4096")
    ...
    image_size_options_json = Column(Text, nullable=False, default="[]")
    custom_size_options_json = Column(Text, nullable=False, default="[]")
