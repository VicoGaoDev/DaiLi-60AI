...
class ExternalApiConfig(Base):
    ...
    poll_result_base64_field = Column(String(255), nullable=False, default="")
    poll_result_url_field = Column(String(255), nullable=False, default="")
    ...
    supports_smart_cutout = Column(Boolean, nullable=False, default=False)
    ...
    is_active_smart_cutout = Column(Boolean, nullable=False, default=False)
